...
export default class Context {
  constructor(parameters) {
    ...
    console.assert(
      ['artoolkit'].indexOf(String(this.parameters.trackingBackend)) !== -1,
  ...
  update(srcElement) {
    ...
    // process this frame
    if (this.parameters.trackingBackend === 'artoolkit') {
      this.#updateArtoolkit(srcElement);
    } else {
  ...
  #initArtoolkit(onCompleted) {
    var _this = this;

    // set this._artoolkitProjectionAxisTransformMatrix to change artoolkit projection matrix axis to match usual webgl one
    this._artoolkitProjectionAxisTransformMatrix = new mat4.create();
    this._artoolkitProjectionAxisTransformMatrix.multiply(new mat4.rotateY(Math.PI));
    this._artoolkitProjectionAxisTransformMatrix.multiply(new mat4.rotateZ(Math.PI));
    ...
    ARController.initWithDimensions(
      ...
      const labelingModeType = labelingModeTypes[_this.parameters.labelingMode];
  ...
  getProjectionMatrix() {
    ...
    const projectionMatrix = mat4.fromValues(...projectionMatrixArr);
    // projectionMatrix.multiply(this._artoolkitProjectionAxisTransformMatrix)
    // return the resultvar projectionMatrix = mat4.fromValues(...projectionMatrixArr);
    return projectionMatrix;
  }

  #updateArtoolkit(srcElement) {
